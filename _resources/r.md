...
|----------|------------------|------------------|-------|
| [Sage Campus: Introduction to R](https://classroom.sagepub.com/course/view.php?id=2) | Sage Campus | Absolute beginners, guided introduction | New to programming |
| [Posit Cloud: R Recipes](https://posit.cloud/learn/recipes) | Posit | Hands-on practice, applied workflows | Beginner–Intermediate |
| [The Carpentries: Data Analysis and Visualization in R for Ecologists](https://datacarpentry.org/R-ecology-lesson/) | Data Carpentry | Data analysis, scientific workflows | Intermediate |
| [Sage Campus: Practical Data Management in R](https://classroom.sagepub.com/course/view.php?id=8) | Sage Campus | Data wrangling and management | Intermediate |
...
| Resource | Author / Provider | Best for (goal) | Level |
|----------|------------------|------------------|-------|
| [Hands-On Programming with R](https://rstudio-education.github.io/hopr/) | Garrett Grolemund | Learning programming fundamentals in R | Beginner |
| [Introduction to R](https://intro2r.com/) | Multiple authors | Foundational concepts and basics | Beginner |
| [R for Data Science](https://r4ds.hadley.nz/) | Hadley Wickham & Garrett Grolemund | Data science, tidyverse workflows | Beginner–Intermediate |

### Documentation / Reference / Practice

| Resource | Author / Provider | Best for (goal) | Level |
|----------|------------------|------------------|-------|
| [R Statistics](https://r-statistics.co/) | Selva Prabhakaran | Practical examples and quick reference | Beginner–Intermediate |
| [R Packages](https://r-packages.io/packages) | Community-driven | Exploring available R packages | Intermediate |
